...
![Docker Image Size (stable)](https://img.shields.io/docker/image-size/jparks1/wine/stable?label=size%20%28stable%29)
![Docker Image Size (devel)](https://img.shields.io/docker/image-size/jparks1/wine/devel?label=size%20%28devel%29)
![Docker Image Size (staging)](https://img.shields.io/docker/image-size/jparks1/wine/staging?label=size%20%28staging%29)
